...
<html>
	...
	<body>
		<article class="page-container">
			<form action="<%=basePath%>/theme/${requestUrl}.do" method="post" class="form form-horizontal" id="edit_form" onsubmit="return requestForm()">
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>歌曲主题名称：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text"  value="${theme.theme}" maxlength="20"
							id="theme" name="theme">
					</div>
				</div>
				<div class="row cl">
					<input type="hidden" id="themeId" value="${theme.themeId}">
	...
	<script type="text/javascript">
		...
		function requestForm(){
			...
			//如果不存在编号则是新增,否则的话是修改
			if(themeId!=''){
				requestData={"themeId":themeId,"theme":theme};
			}else{
				requestData={"theme":theme};
			}
			//获取请求路径
			var form=$("#edit_form");
