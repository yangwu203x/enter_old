...
<html>
	...
	<body>
		<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>用户行为管理<span class="c-gray en">&gt;</span>用户行为列表<span class="c-gray en">&gt;</span>用户行为详细<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
...
<%-- 					<c:if test="${sessionScope.role.add==1}">
 ...
 --%>				</span> 
				...
				<tbody>
					<c:forEach items="${statistics}" var="statistic">
						<tr class="text-c">
							...
							<td>${statistic.songId}</td>
							<td>${statistic.songName}</td>
	...
	function detailStatistic(userId){
		location.href="<%=basePath%>/behavior/showUserStatistics.do?userId="+userId;
	}
 	</script> 
</html>