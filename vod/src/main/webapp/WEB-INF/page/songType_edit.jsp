...
<html>
	...
	<body>
		<article class="page-container">
			<form action="<%=basePath%>/songType/${requestUrl}.do" method="post" class="form form-horizontal" id="edit_form" onsubmit="return requestForm()">
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>歌曲类型文名：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text"  value="${songType.type}" 
							id="type" name="type">
					</div>
				</div>
				<div class="row cl">
					<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
						<input type="hidden" id="typeId" value="${songType.id}">
	...
	<script type="text/javascript">
		...
		function requestForm(){
			...
			//如果不存在编号则是新增,否则的话是修改
			if(type_id!=''){
				requestData={"type":type,"typeId":typeId};
			}else{
