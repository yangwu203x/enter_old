...
public class TestUnit {
    ...
    public static void main(String[] args) {
        try {
            DbSearcher _searcher = new DbSearcher(new DbConfig(), "C:/Users/Administrator/Desktop/workspace/ip2region/data/ip2region.db");
            BufferedReader bfr   = new BufferedReader(new FileReader("C:/Users/Administrator/Desktop/workspace/ip2region/data/ip.merge.txt"));
            BufferedWriter bwr   = new BufferedWriter(new FileWriter("C:/Users/Administrator/Desktop/workspace/ip2region/data/error_log.txt", true));
            int errCount  = 0;
            int lineCount = 0;
            String str = null;
